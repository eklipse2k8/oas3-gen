...
pub const X_API_VERSION: http::HeaderName = http::HeaderName::from_static(
    "x-api-version",
);
...
impl CreatePetsRequest {
    ...
    pub async fn parse_response(
        ...
        let data = oas3_gen_support::Diagnostics::<Error>::json_with_diagnostics(req)
            .await?;
        return Ok(CreatePetsResponse::Unknown(data));
    }
}
...
impl ListCatsRequest {
    ...
    pub async fn parse_response(
        req: reqwest::Response,
    ) -> anyhow::Result<ListCatsResponse> {
        let status = req.status();
        if status == http::StatusCode::OK {
            let data = oas3_gen_support::Diagnostics::<Cats>::json_with_diagnostics(req)
                .await?;
            return Ok(ListCatsResponse::Ok(data));
        }
        let data = oas3_gen_support::Diagnostics::<Error>::json_with_diagnostics(req)
            .await?;
        return Ok(ListCatsResponse::Unknown(data));
    }
}
...
impl ListPetsRequest {
    ...
    pub async fn parse_response(
        ...
        let data = oas3_gen_support::Diagnostics::<Error>::json_with_diagnostics(req)
            .await?;
        return Ok(ListPetsResponse::Unknown(data));
    }
}
#[derive(Debug, Clone, PartialEq, oas3_gen_support::Default)]
...
impl ShowPetByIdRequest {
    ...
    pub async fn parse_response(
        ...
        let data = oas3_gen_support::Diagnostics::<Error>::json_with_diagnostics(req)
            .await?;
        return Ok(ShowPetByIdResponse::Unknown(data));
    }
}
#[derive(Debug, Clone, PartialEq, validator::Validate, oas3_gen_support::Default)]
...
impl core::convert::TryFrom<&ShowPetByIdRequestHeader> for http::HeaderMap {
    type Error = http::header::InvalidHeaderValue;
    fn try_from(
        headers: &ShowPetByIdRequestHeader,
    ) -> core::result::Result<Self, Self::Error> {
        let mut map = http::HeaderMap::with_capacity(1usize);
...
impl UploadPetImageRequest {
    ...
    pub fn new(pet_id: String, body: UploadRequestBody) -> anyhow::Result<Self> {
        let request = Self {
            path: UploadPetImageRequestPath {
                pet_id,
            },
            body,
        };
