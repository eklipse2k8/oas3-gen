...
impl SwaggerPetstoreClient {
    ...
    pub async fn list_cats(
        ...
        let response = self
            ...
            .send()
            .await?;
        Ok(ListCatsRequest::parse_response(response).await?)
    }
    ...
    pub async fn show_pet_by_id(
        ...
        url.path_segments_mut()
            .map_err(|()| anyhow::anyhow!("URL cannot be a base"))?
            .push("pets")
            .push(&request.path.pet_id.to_string());
        let response = self
            .client
            .get(url)
            .headers(
            ...
            .send()
            .await?;
        Ok(ShowPetByIdRequest::parse_response(response).await?)
    }
        ...
        form = form
            .part(
                ...
                reqwest::multipart::Part::bytes(
                    std::borrow::Cow::from(body.image.clone()),
                ),
            );
        form = form.part("name", reqwest::multipart::Part::text(body.name.to_string()));
        req_builder = req_builder.multipart(form);
        let response = req_builder.send().await?;
        Ok(UploadPetImageRequest::parse_response(response).await?)
    }
    /// List all pets
    ///
    ...
    pub async fn list_pets(
        ...
        url.path_segments_mut()
            .map_err(|()| anyhow::anyhow!("URL cannot be a base"))?
            .push(&request.path.api_version.to_string())
            .push("pets");
        let response = self
            .client
            .get(url)
            ...
            .send()
            .await?;
        Ok(ListPetsRequest::parse_response(response).await?)
    }
    /// Create a pet
    ///
    ...
    pub async fn create_pets(
        ...
        Ok(CreatePetsRequest::parse_response(response).await?)
    }
}
