...
| `converter/unions.rs`               | `EnumConverter` + `UnionConverter` for oneOf/anyOf handling         |
...
- [unions.rs](crates/oas3-gen/src/generator/converter/unions.rs) - oneOf/anyOf conversion
